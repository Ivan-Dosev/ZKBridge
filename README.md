...
MANTLE_SEPOLIA_VERIFIER_ADDRESS=your_verifier_address_here
FLOW_TESTNET_VERIFIER_ADDRESS=your_verifier_address_here
RONIN_TESTNET_VERIFIER_ADDRESS=your_verifier_address_here
FLARE_COSTON2_VERIFIER_ADDRESS=your_verifier_address_here
SAGA_TEST_VERIFIER_ADDRESS=your_verifier_address_here
SAGA_DEMO_VERIFIER_ADDRESS=your_verifier_address_here

# Contract Addresses - BridgeWithZKP
MANTLE_SEPOLIA_BRIDGE_ADDRESS=your_bridge_address_here
FLOW_TESTNET_BRIDGE_ADDRESS=your_bridge_address_here
RONIN_TESTNET_BRIDGE_ADDRESS=your_bridge_address_here
FLARE_COSTON2_BRIDGE_ADDRESS=your_bridge_address_here
SAGA_TEST_BRIDGE_ADDRESS=your_bridge_address_here
SAGA_DEMO_BRIDGE_ADDRESS=your_bridge_address_here

# Your private key for deployment (keep this secret!)
PRIVATE_KEY=your_private_key_here

# React environment variables
REACT_APP_MANTLE_SEPOLIA_BRIDGE_ADDRESS=your_bridge_address_here
REACT_APP_FLOW_TESTNET_BRIDGE_ADDRESS=your_bridge_address_here
REACT_APP_RONIN_TESTNET_BRIDGE_ADDRESS=your_bridge_address_here
REACT_APP_FLARE_COSTON2_BRIDGE_ADDRESS=your_bridge_address_here
REACT_APP_SAGA_TEST_BRIDGE_ADDRESS=your_bridge_address_here
REACT_APP_SAGA_DEMO_BRIDGE_ADDRESS=your_bridge_address_here
